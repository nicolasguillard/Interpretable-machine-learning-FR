...
![](../_static/images2/5_5_1_table_1.png){align=center}

OneR crée les tableaux croisés entre chaque fonctionnalité et le résultat :

![](../_static/images2/5_5_1_table_2.png){align=center}
...
![](../_static/images2/5_5_1_table_3.png){align=center}
...
![](../_static/images2/5_5_1_table_4.png){align=center}
...
![](../_static/images2/5_5_1_table_5.png){align=center}
...
![L'algorithme de couverture fonctionne en couvrant séquentiellement l'espace des fonctionnalités avec des règles uniques et en supprimant les points de données déjà couverts par ces règles. À des fins de visualisation, les fonctionnalités x1 et x2 sont continues, mais la plupart des algorithmes d'apprentissage de règles nécessitent des fonctionnalités catégorielles.](../_static/images2/5_5_2_figure_1.png){align=center}
...
![Apprendre une règle en recherchant un chemin dans un arbre de décision. Un arbre de décision est développé pour prédire la cible d'intérêt. Nous commençons au nœud racine, suivons goulûment et itérativement le chemin qui produit localement le sous-ensemble le plus pur (par exemple la plus haute précision) et ajoutons toutes les valeurs divisées à la condition de règle. On obtient : Si `location = good` et `size = big`, alors value=high.](../_static/images2/5_5_2_figure_2.png){align=center}
...
![](../_static/images2/5_5_2_table_1.png){align=center}
...
![](../_static/images2/5_5_3_table_2.png){align=center}
...
![](../_static/images2/5_5_3_table_3.png){align=center}
...
![](../_static/images2/5_5_3_table_4.png){align=center}
