...
![The logistic function. It outputs numbers between 0 and 1. At input 0, it outputs 0.5.](../_static/images2/5_2_2_logistic_function.png){align=center}
...
![The logistic regression model finds the correct decision boundary between malignant and benign depending on tumor size. The line is the logistic function shifted and squeezed to fit the data.](../_static/images2/5_2_2_tumor_size.png){align=center}
...
![The results of fitting a logistic regression model on the cervical cancer dataset. Shown are the features used in the model, their estimated weights and corresponding odds ratios, and the standard errors of the estimated weights.](../_static/images2/5_2_4_example_table.png){align=center}
