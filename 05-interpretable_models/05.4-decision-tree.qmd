...
![Arbre de décision avec données artificielles. Les instances avec une valeur supérieure à 3 pour la fonctionnalité x1 se retrouvent dans le noeud 5. Toutes les autres instances sont affectées au noeud 3 ou au noeud 4, selon que les valeurs de la fonctionnalité x2 dépassent 1.](../_static/images2/5_4_tree.png){align=center}
...
![Importance des caractéristiques mesurées par l'amélioration moyenne de la pureté du noeud.](../_static/images2/5_4_2_importance.png){align=center}
