...
![A saliency map in which pixels are colored by their contribution to the classification.](../_static/images/vanilla.png){align=center}
...
::: {.callout-important}
**NdT :** Vérifier et illustrer l'exemple précédent
:::
...
![Images of a dog classified as greyhound, a ramen soup classified as soup bowl, and an octopus classified as eel.](../_static/images/original-images-classification.png){align=center}
...
![Pixel attributions or saliency maps for the Vanilla Gradient method, SmoothGrad and Grad-CAM.](../_static/images/smoothgrad.png){align=center}
