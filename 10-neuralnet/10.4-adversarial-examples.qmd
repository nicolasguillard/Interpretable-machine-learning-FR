...
![By intentionally changing a single pixel a neural network trained on ImageNet can be deceived to predict the wrong class instead of the original class.](../_static/images/adversarial-1pixel.png){align=center}
...
![A sticker that makes a VGG16 classifier trained on ImageNet categorize an image of a banana as a toaster. Work by Brown et al. (2017).](../_static/images/adversarial-toaster.png){align=center}
...
![Athalye et al. (2017) created a 3D-printed that is recognized as a rifle by TensorFlow’s standard pre-trained InceptionV3 classifier.](../_static/images/adversarial-turtle.png){align=center}
