...
Nous pouvons certainement utiliser des [méthodes agnostiques au modèle](/06-model_agnostic_methods/), telles que les [modèles locaux](/09-local_model_agnostic_methods/) ou les [graphiques de dépendance partielle](/09-local_model_agnostic_methods/), mais il y a deux raisons pour lesquelles il est judicieux de considérer des méthodes d'interprétation développées spécifiquement pour les réseaux neuronaux : 
