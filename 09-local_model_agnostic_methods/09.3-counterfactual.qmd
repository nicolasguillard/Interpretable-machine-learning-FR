...
![Les relations causales entre les entrées d'un modèle d'apprentissage automatique et les prédictions, lorsque le modèle est simplement vu comme une boîte noire. Les entrées provoquent la prédiction (ne reflétant pas nécessairement la relation causale réelle des données).](../_static/images/graph.jpg){align=center}
...
![Visualisation d'une génération de l'algorithme NSGA-II.](../_static/images/cfexp-nsgaII.jpg){align=center}
