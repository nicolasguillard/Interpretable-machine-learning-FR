...
![LIME vs. Anchors – Une visualisation de jouet. Figure de Ribeiro, Singh et Guestrin (2018).](../_static/images/anchors-visualization.png){align=center}
...
![Les composants de l'algorithme d'ancrage et leurs interrelations (simplifié).](../_static/images/anchors-process.jpg){align=center}
...
![Expliquer les instances proches des limites de décision conduit à des règles spécifiques comprenant un nombre plus élevé de prédicats de fonctionnalités et une couverture plus faible. De plus, la règle vide, c'est-à-dire la fonctionnalité de base, devient moins importante. Cela peut être interprété comme un signal pour une limite de décision, car l'instance est située dans un quartier instable.](../_static/images2/9_4_3_fig_2.png){align=center}
...
![Construire des ancres dans des espaces de perturbations déséquilibrés conduit à des résultats inexpressifs.](../_static/images2/9_4_3_fig_3.png){align=center}
...
![Équilibrer l'ensemble de données avant de construire des ancrages montre le raisonnement du modèle pour les décisions dans les cas minoritaires.](../_static/images2/9_4_3_fig_4.png){align=center}
