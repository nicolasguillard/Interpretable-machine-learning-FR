...
![Graphiques ICE des locations de vélos prévues en fonction des conditions météorologiques. Les mêmes effets peuvent être observés que dans les diagrammes de dépendance partielle.](../_static/images2/9_1_1_fig_2.png){align=center}
...
![Graphique ICE centré pour la probabilité prévue de cancer par âge. Les lignes sont fixées à 0 à 14 ans. Par rapport à 14 ans, les prédictions pour la plupart des femmes restent inchangées jusqu'à l'âge de 45 ans, où la probabilité prédite augmente.](../_static/images2/9_1_1_2_fig_1.png){align=center}
...
![Graphiques ICE centrés du nombre prévu de vélos selon les conditions météorologiques. Les lignes montrent la différence de prédiction par rapport à la prédiction avec la valeur de la caractéristique respective à son minimum observé.](../_static/images2/9_1_1_2_fig_2.png){align=center}
