...
![Prototypes et critiques pour une distribution de données à deux fonctionnalités x1 et x2.](../_static/images2/8_7_fig_1.png){align=center}
...
![The squared maximum mean discrepancy measure (MMD2) for a dataset with two features and different selections of prototypes.](../_static/images2/8_7_1_fig_1.png){align=center}
...
![Évaluations de la fonction témoin en différents points.](../_static/images2/8_7_1_fig_2.png){align=center}
...
![Prototypes pour un ensemble de données de chiffres manuscrits.](../_static/images/handwritten-prototypes.png){align=center}
