...
![Les nœuds terminaux d'un arbre de substitution qui se rapproche des prédictions d'une forêt aléatoire formée sur l'ensemble de données sur le cancer du col de l'utérus. Les décomptes dans les nœuds montrent la fréquence des classifications des modèles de boîte noire dans les nœuds.).](../_static/images2/8_6_2_fig_2.png){align=center}
